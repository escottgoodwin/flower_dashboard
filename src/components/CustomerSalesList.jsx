...
class CustomerSalesList extends Component {
      ...
      <GridItem xs={12} sm={12} md={12}>
        <Card>
          <CardHeader color="info">
            <h4 className={classes.cardTitleWhite}>Sales - {totalNum} - ${totalValue}</h4>
...
CustomerSalesList.propTypes = {
  classes: PropTypes.object
};

export default withStyles(styles)(CustomerSalesList);
